...
export const metadata: Metadata = {
  ...
  description: "Bold Video privacy policy — how we collect, use, and protect your data.",
};
    ...
    <PageShell>
      <main id="main-content" className="flex-1 px-4 py-20">
        <article className="prose prose-gray mx-auto max-w-3xl">
          ...
          <p>
            This Privacy Policy applies to the Bold Video website, user accounts, uploaded or
            connected videos and transcripts, and related tools and communications.
          </p>
          ...
          <ul>
            ...
            <li>We do not use your private video content to train public AI models</li>
          ...
          <p>
            Protective measures include secure hosting, encryption, access controls, and monitoring.
            No system is 100 percent secure, but protecting your content is a core priority.
          </p>

          <h2>7. Data Retention</h2>
          <p>
            Data is retained while your account is active, service delivery requires it, or legal
            obligations exist. You can delete content or close your account anytime.
          </p>

          <h2>8. Your Rights</h2>
          <p>
            You may access, correct, delete, export your data, or withdraw consent based on your
            location.
          </p>

          <h2>9. Cookies</h2>
          <p>
            Cookies are used for sign-in maintenance, usage analysis, and performance improvement.
            You can control cookies via your browser settings.
          </p>

          <h2>10. Third-Party Services</h2>
          <p>
            Integrations with external platforms are governed by their own privacy policies.
          </p>

          <h2>11. Policy Changes</h2>
          <p>Updates will be communicated via the website or account notification.</p>
